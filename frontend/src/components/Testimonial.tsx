...
export default function Testimonial() {
  ...
  return (
    <CenterAligner className="bg-gray-100 px-5 py-8">
      <h1 className="text-center text-2xl font-bold sm:text-3xl pb-8">
        Testimonials and Success Stories
      </h1>
      <p className="text-center text-lg font-medium sm:text-xl pb-8">
        At Uptick Talent, we take immense pride in the accomplishments of our
        startup graduates. Our programs are designed to nurture innovation and
        provide the knowledge and resources necessary for success. Here are some
                ...
                <section className="mx-auto bg-white p-5 sm:p-12 grid grid-cols-1 sm:grid-cols-[1fr_3fr] md:grid-cols-[1fr_4fr] items-center gap-5 md:gap-8 rounded-xl overflow-hidden">
                  ...
                  <div className="space-y-5 text-center">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">{single.website}</p>
                    </div>
                  </div>
                  ...
                  <div className="text-[16px] sm:text-[18px] space-y-3">
                    {/* Testimonial */}
                    <div className="text-deep text-[40px]">
                      <FaQuoteLeft />
                    </div>
