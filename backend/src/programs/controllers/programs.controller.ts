...
export class ProgramsController {
  ...
  @ApiResponse({
    status: 200,
    description: 'Returns a list of programs that matches the filters',
  })
  async getPrograms(
  ...
  async getAvailablePrograms(
    ...
    {
      return await this.programsService.getAvailablePrograms(
        order_by,
        order_direction,
        type,
      );
  ...
  async getUnavailablePrograms(
    ...
    {
      return await this.programsService.getUnavailablePrograms(
        order_by,
        order_direction,
        type,
      );
